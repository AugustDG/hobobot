...
float ddrive_t::get_left_angular_vel() const
{
    return angular_wheel_velocities[0];
}

float ddrive_t::get_right_angular_vel() const
{
    return angular_wheel_velocities[1];
}

float ddrive_t::get_left_linear_vel() const
{
    return linear_wheel_velocities[0];
}

float ddrive_t::get_right_linear_vel() const
{
    return linear_wheel_velocities[1];
}
